  ...
  return (
    <div className="p-4 sm:p-6 w-full">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Monitor all orders across the platform</p>
      </div>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((order) => (
                    <tr key={order._id} className="border-b hover:bg-gray-50">
                      <td className="py-3 px-4 font-medium text-gray-900">{order.buyerInfo?.name}</td>
                      ...
                      <td className="py-3 px-4">
                        <span className={`text-xs px-2 py-1 rounded font-medium capitalize ${statusColors[order.orderStatus] || "bg-gray-100 text-gray-700"}`}>
                          {order.orderStatus}
                        </span>
                      </td>
                      <td className="py-3 px-4">
                        ...
                        >
                          {["pending","accepted","processing","shipped","delivered","rejected"].map((s) => (
